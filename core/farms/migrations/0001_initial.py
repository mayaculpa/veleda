# Generated by Django 2.2.8 on 2019-12-14 21:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('farm', models.ForeignKey(blank=True, help_text='The farm to which the coordinator belongs.', null=True, on_delete=django.db.models.deletion.CASCADE, to='farms.Farm')),
            ],
        ),
        migrations.CreateModel(
            name='Controller',
            fields=[
                ...
                ('coordinator', models.ForeignKey(help_text='The coordinator with which the controller is connected to.', null=True, on_delete=django.db.models.deletion.CASCADE, to='farms.Coordinator')),
            ],
        ),
    ]
